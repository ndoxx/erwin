...
def main():
	default_kbd_path = '../source/Applications/Editor/config/default_keybindings.xml'
	...
	hf.write('\n')
	hf.write('static const std::string s_default_keybindings_path = "source/Applications/Editor/config/default_keybindings.xml";\n')
	hf.write('\n')
