...
public:
	...
	PoolAllocator(HeapArea& area, std::size_t node_size, std::size_t decoration_size, std::size_t max_nodes, const char* debug_name);
	// PoolAllocator(void* begin, std::size_t node_size, std::size_t max_nodes, std::size_t arena_decoration_size);

	void init(HeapArea& area, std::size_t node_size, std::size_t decoration_size, std::size_t max_nodes, const char* debug_name);
