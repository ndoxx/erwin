...
public:
	void init()
	{
		...
		// TextureHandle hdr_tex = AssetManager::load_image("textures/hdr/lakeside_1k.hdr", width, height);
		// TextureHandle hdr_tex = AssetManager::load_image("textures/hdr/dirt_bike_track_01_1k.hdr", width, height);
		// TextureHandle hdr_tex = AssetManager::load_image("textures/hdr/georgentor_2k.hdr", width, height);
		TextureHandle hdr_tex = AssetManager::load_image("textures/hdr/small_cathedral_2k.hdr", width, height);
