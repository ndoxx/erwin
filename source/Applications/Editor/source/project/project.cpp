...
fs::path get_asset_path(DirKey dir_key)
{
	...
	switch(dir_key)
	{
		case DirKey::ATLAS:    dirpath = s_current_project.registry.get("project.content.export.atlas"_h); break;
		case DirKey::HDR:      dirpath = s_current_project.registry.get("project.content.export.hdr"_h); break;
		case DirKey::MATERIAL: dirpath = s_current_project.registry.get("project.content.export.material"_h); break;
		case DirKey::FONT:     dirpath = s_current_project.registry.get("project.content.export.font"_h); break;
		case DirKey::MESH:     dirpath = s_current_project.registry.get("project.content.export.mesh"_h); break;

		case DirKey::WORK_ATLAS:    dirpath = s_current_project.registry.get("project.content.import.atlas"_h); break;
		case DirKey::WORK_HDR:      dirpath = s_current_project.registry.get("project.content.import.hdr"_h); break;
		case DirKey::WORK_MATERIAL: dirpath = s_current_project.registry.get("project.content.import.material"_h); break;
		case DirKey::WORK_FONT:     dirpath = s_current_project.registry.get("project.content.import.font"_h); break;
		case DirKey::WORK_MESH:     dirpath = s_current_project.registry.get("project.content.import.mesh"_h); break;
	}
